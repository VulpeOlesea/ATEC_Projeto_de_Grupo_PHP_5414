...
if(!$edit){
	...
	<h3>Criar Novo Produto</h3>
		<form method="post" enctype="multipart/form-data">
			<div class="form-floating mb-3">
			   	<input class="form-control" id="prod_name" type="text" placeholder="Nome do Produto" name="prod_name" required />
	...
	';
		...
		if(isset($_POST['bt_novo_produto'])){
			function_new_product($_POST['prod_name'], $_POST['prod_price'], $_POST['prod_description'], $_POST['prod_category'], $_POST['prod_image']);
		}
