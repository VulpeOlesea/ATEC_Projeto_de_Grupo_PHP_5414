...
function function_section_products(){
    ...
    $q = mysqli_query($conn,"SELECT prod_image, prod_name, prod_author, prod_price FROM products");
            ...
            <div class="col-md-3">
                <div class="product-item">
                    <figure class="product-style">
                        ...
                        <button type="button" class="add-to-cart" data-product-tile="add-to-cart">Adicionar ao carrinho</button>
                    </figure>
                    <figcaption>
                        <h3>'.$a["prod_name"].'</h3>
